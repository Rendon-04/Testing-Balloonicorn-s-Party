...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{'type': 'drink'},{'type': 'drink'}])
    ('drink', 'drink')

    >>> most_and_least_common_type([{'type': 'drink'},{'type': 'drink'},{'type': 'dessert'}])
    ('drink', 'dessert')

    >>> most_and_least_common_type([{'type': 'drink'},{'type': 'drink'},{'type': 'dessert'},{'type': 'dessert'}])
    ('drink', 'drink')

    >>> most_and_least_common_type([{'type': 'drink'},{'type': 'drink'},{'type': 'dessert'},{'type': 'dessert'},{'type':'appetizer'}])
    ('drink', 'appetizer')
